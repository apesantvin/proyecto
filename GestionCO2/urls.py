...
urlpatterns = [
    ...
    path('añadir_edificioconsumo/<int:pk>/', views.añadir_edificioconsumo, name='añadir_edificioconsumo'),
    path('añadir_vehiculoconsumo/<int:pk>/', views.añadir_vehiculoconsumo, name='añadir_vehiculoconsumo'),
